...
export const TILE_TYPES = {
    ...
    // MODIFIÉ: La forêt a maintenant des coûts en stats
    FOREST: { 
        name: 'Forêt', 
    ...
    // MODIFIÉ: La friche peut être arrosée
    WASTELAND: { 
        name: 'Friche', 
        accessible: true, 
        color: '#9c6644', 
        background: ['bg_wasteland_1', 'bg_wasteland_2', 'bg_wasteland_3', 'bg_wasteland_4'],
        regeneration: { cost: { 'Eau': 5 }, target: 'FOREST' } // Nouvelle propriété pour la régénération
    },
    ...
    // MODIFIÉ: Nouvelles règles pour le sommeil
    SHELTER_INDIVIDUAL: { 
    ...
    MINE: { 
        name: 'Mine', 
        accessible: true, // On doit pouvoir entrer dedans pour miner
        color: '#5e503f', 
        background: ['bg_mine'],
