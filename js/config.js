...
// MODIFIÉ : Ajout des chemins pour les images des gisements de pierre
export const SPRITESHEET_PATHS = {
    ...
    // NOUVEAU : Images pour les gisements de pierre
    bg_stone_1: 'assets/bg_stone_1.png', // Remplacez par le nom de votre fichier
    bg_stone_2: 'assets/bg_stone_2.png', // Optionnel, pour la variété
...
// MODIFIÉ : Attribution des nouvelles images de fond aux gisements de pierre
export const TILE_TYPES = {
    ...
    // La ligne ci-dessous est la seule qui change vraiment de logique
    ...
    SHELTER_COLLECTIVE: { name: 'Abri Collectif', accessible: true, color: '#ffffff', background: ['bg_shelter_collective'] },
